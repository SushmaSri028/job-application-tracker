...
import com.sushma.jobtracker.service.CustomUserDetailsService;
...
public class SecurityConfig {
    ...
    /** Tells Spring "use my DB lookup + BCrypt to verify logins." */
    @Bean
    ...
    /** Exposes the auth manager so AuthService can use it during login. */
    @Bean
